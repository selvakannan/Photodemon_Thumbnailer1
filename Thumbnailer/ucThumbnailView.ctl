...
Private m_eColumnSortOrder(20)  As tvSortOrderConstants
...
Public Function Initialize(ByVal FormatsMask As String, _
                           ...
                           Optional ByVal heightColumnWidth As Long = 100, _
                           Optional ByVal extensionColumnWidth As Long = 100) As Boolean
    
    If (m_bInitialized = False) Then
    
        Initialize = pvCreate(FormatsMask, MaskSeparator, ViewMode, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100)
...
Public Function ItemAdd( _
                ...
                ByVal Filelastaccesstime As String, _
                ByVal Filelastwritetime As String, _
                ByVal Filecrc As String, _
                ByVal FilePath As String, _
                ByVal Filewidth As String _
                                                ) As Boolean
  ...
  Dim uITI As IMAGETYPE_INFO
    ...
    If (m_hListView) Then
        ...
        Call pvSubItemSet(Item, 1, uITI.Name) 'file type details
        Call pvSubItemSet(Item, 2, Format$(FileSize, "#,0"))
        Call pvSubItemSet(Item, 3, FileDate)
        Call pvSubItemSet(Item, 4, Filecreationdate)
        Call pvSubItemSet(Item, 5, Filelastaccesstime)
        Call pvSubItemSet(Item, 6, Filelastwritetime)
        Call pvSubItemSet(Item, 7, Filecrc)
        Call pvSubItemSet(Item, 8, FilePath)
        Call pvSubItemSet(Item, 9, Filewidth)
        Call pvSubItemSet(Item, 10, Filewidth)
        Call pvSubItemSet(Item, 11, uITI.Extension)
        Call pvSubItemSet(Item, 12, uITI.IconIndex)
    End If
End Function
...
Public Sub SetThumbnailSize(ByVal New_Width As Long, ByVal New_Height As Long)
    ...
    If (m_ThumbnailWidth > 280) Then m_ThumbnailWidth = 280
    If (m_ThumbnailHeight < 32) Then m_ThumbnailHeight = 32
    If (m_ThumbnailHeight > 280) Then m_ThumbnailHeight = 280
...
Private Function pvCreate(ByVal FormatsMask As String, _
                          ...
                          ByVal creationdateColumnWidth As Long, _
                          ByVal lastaccesstimeColumnWidth As Long, _
                          ByVal lastwritetimeColumnWidth As Long, _
                          ByVal crcColumnWidth As Long, _
                          ByVal pathColumnWidth As Long, _
                          ByVal heightColumnWidth As Long) As Boolean
  ...
  Dim lLVStyle As Long
    ...
    If (m_hListView) Then
        ...
        '-- Initialize columns
        Call pvColumnAdd(0, "Name", 100)
        Call pvColumnAdd(1, "Type", 100)
        Call pvColumnAdd(2, "Size", 100, [tvRight])
        Call pvColumnAdd(3, "Date", 100)
        Call pvColumnAdd(4, "Creation date", 100)
        Call pvColumnAdd(5, "Last access Time", 100)
        Call pvColumnAdd(6, "Last write Time", 100)
        Call pvColumnAdd(7, "crc", 100)
        Call pvColumnAdd(8, "Folder", 100)
        Call pvColumnAdd(9, "width", 100)
        Call pvColumnAdd(10, "height", 100)
        Call pvColumnAdd(11, "extension", 100)
        Call pvColumnAdd(12, "icon index", 100)
  ...
  Dim lCol As Long
    ...
    If (m_hListView) Then
        ...
        Select Case lColumnID
            ...
            Case 4: pvSort = mListViewSort.Sort(m_hListView, 4, m_eColumnSortOrder(4), [tvDate])
            Case 5: pvSort = mListViewSort.Sort(m_hListView, 5, m_eColumnSortOrder(5), [tvDate])
            Case 6: pvSort = mListViewSort.Sort(m_hListView, 6, m_eColumnSortOrder(6), [tvDate])
            Case 7: pvSort = mListViewSort.Sort(m_hListView, 7, m_eColumnSortOrder(7), [tvString])
            Case 8: pvSort = mListViewSort.Sort(m_hListView, 8, m_eColumnSortOrder(8), [tvString])
            Case 9: pvSort = mListViewSort.Sort(m_hListView, 9, m_eColumnSortOrder(9), [tvString])
            Case 10: pvSort = mListViewSort.Sort(m_hListView, 10, m_eColumnSortOrder(10), [tvString])
            Case 11: pvSort = mListViewSort.Sort(m_hListView, 11, m_eColumnSortOrder(11), [tvString])
        End Select
    End If
End Function
