...
Public Sub LoadSettings()
  ...
  Dim lc   As Long
    ...
    With uAPP_SETTINGS
        ...
        '-- Various
        .ThumbnailWidth = pvGetINI(sINI, "Options", "ThumbnailWidth", 280)
        .ThumbnailHeight = pvGetINI(sINI, "Options", "ThumbnailHeight", 280)
        ...
        For lc = 0 To 24
            ...
            If (sVal <> vbNullString) Then
                Call frm_Thumbnailer.cbPath.AddItem(sVal)
              Else
                Exit For
            End If
        Next lc
...
Public Sub SaveSettings()
  ...
  Dim lc   As Long
    ...
    With uAPP_SETTINGS
        ...
        '-- Recent paths
        For lc = 0 To 24
            sVal = frm_Thumbnailer.cbPath.List(lc)
            If (sVal <> vbNullString) Then
